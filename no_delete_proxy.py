...
# here in this code the proxy is not deleted from the file automatically !!
...
async def connect_to_wss(socks5_proxy, user_id):
    ...
    while True:
        try:
            ...
            if any(error_msg in str(e) for error_msg in ["Device creation limit exceeded"]):
...
async def main():
    ...
    proxy_file = 'input_proxy.txt'  # your Path to Proxy3.txt file
